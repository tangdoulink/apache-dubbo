 ...
 */
// @Service
// @DubboService(version = "1.0.0",interfaceName="org.apache.dubbo.demo.DemoService",tag = "demo")
public class DemoServiceImpl implements DemoService {
    ...
    public HelloReply sayHello(HelloRequest request) {
        logger.info("hello {} , request from consumer: {} ",request.getName(),RpcContext.getServerContext().getRemoteAddress());
